            ...
            <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
                    <div>
                        ...
                        <p className="text-text-secondary text-sm mt-0.5">{mockInterviews.length} total interviews created</p>
                    </div>
                                ...
                                <div className="flex items-start gap-4 flex-1">
                                    ...
                                    <div className="flex-1 min-w-0">
                                        <div className="flex flex-wrap items-center gap-2 mb-1">
                                            ...
                                            <Badge variant={statusColors[interview.status]} dot size="sm">
                                        ...
                                        <p className="text-sm text-text-muted mb-3 line-clamp-1">{interview.description}</p>
                                        <div className="flex flex-wrap items-center gap-4 text-xs text-text-muted">
                                            ...
                                            {interview.deadline && (
                                                <span className="flex items-center gap-1.5"><Calendar className="w-3.5 h-3.5" />
                                                    Due {interview.deadline.toLocaleDateString()}
                                                </span>
                                            )}
                                        </div>
                                        {/* Round Types */}
